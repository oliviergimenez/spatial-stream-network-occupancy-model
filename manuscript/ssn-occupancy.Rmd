...
```{r postrace, out.width="98%", fig.align='center', fig.pos='b', fig.cap="Posterior distribution and trace plots $\\beta_0$, $\\beta_1$, $\\beta_2$, $\\sigma$, $\\theta$, $p$ is the detection probability."}
