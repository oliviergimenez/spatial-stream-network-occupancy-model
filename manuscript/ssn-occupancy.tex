...
\caption{Posterior distribution and trace plots $\beta_0$, $\beta_1$, $\beta_2$, $\sigma$, $\theta$, $p$ is the detection probability.}\label{fig:postrace}
\end{figure}
